...
(function () {
  ...
  u.enc.Base64 = {
    stringify: function (d) {
      ...
      d = []
      for (var r = 0; r < p; r += 3) {
        for (var w = (l[r >>> 2] >>> 24 - 8 * (r % 4) & 255) << 16 | (l[r + 1 >>> 2] >>> 24 - 8 * ((r + 1) % 4) & 255) << 8 | l[r + 2 >>> 2] >>> 24 - 8 * ((r + 2) % 4) & 255, v = 0; v < 4 && r + 0.75 * v < p; v++) {
...
CryptoJS.getRandomIV = function (n) {
  return getRandomIV(n)
}
